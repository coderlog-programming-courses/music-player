...
# Form implementation generated from reading ui file '/home/south/python/music-player/window.ui'
#
...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/home/south/python/music-player/button_image/active_button_musics.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.music_button.setIcon(icon)
...
"}")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/home/south/python/music-player/button_image/deactive_button_playlists.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.playlist_button.setIcon(icon1)
...
"border-color: #3E3838;")
        ...
        self.scrollArea = QtWidgets.QScrollArea(self.playlist_frame)
        self.scrollArea.setGeometry(QtCore.QRect(0, 0, 297, 404))
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 297, 404))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.scrollAreaWidgetContents.sizePolicy().hasHeightForWidth())
        self.scrollAreaWidgetContents.setSizePolicy(sizePolicy)
        self.scrollAreaWidgetContents.setMinimumSize(QtCore.QSize(0, 40))
        self.scrollAreaWidgetContents.setSizeIncrement(QtCore.QSize(297, 40))
        self.scrollAreaWidgetContents.setBaseSize(QtCore.QSize(297, 40))
        self.scrollAreaWidgetContents.setObjectName("scrollAreaWidgetContents")
        self.playlist_frame_layout = QtWidgets.QVBoxLayout(self.scrollAreaWidgetContents)
        ...
        self.playlist_frame_layout.addWidget(self.frame)
        self.frame_2 = QtWidgets.QFrame(self.scrollAreaWidgetContents)
        self.frame_2.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_2.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_2.setObjectName("frame_2")
        self.playlist_frame_layout.addWidget(self.frame_2)
